...
class BasicParser {
    ...
    private var expression = expression0.expression(factor, operators, BinaryExpression::class.java)
    ...
    init {
        ...
        OperatorDefinition.values().forEach { operators.add(it.rawOperator, it.precedence, it.assoc) }
    }
